self.importScripts(
  './buffer-selection.js?v=algset-controls-v1',
  './wide-move-translator.js?v=algset-controls-v1',
  './scrambling.js?v=algset-controls-v1',
  './corner-tracing.js?v=algset-controls-v1',
  './edge-common.js?v=algset-controls-v1',
  './cycle-model.js?v=algset-controls-v1',
  './cycle-residue.js?v=algset-controls-v1',
  './cycle-residue-planner.js?v=algset-controls-v1',
  './finalizing.js?v=algset-controls-v1',
  './big-cube-model.js?v=algset-controls-v1',
  './big-cube-tracing.js?v=algset-controls-v1',
  './four-by-four.js?v=algset-controls-v1',
  './five-by-five.js?v=algset-controls-v1',
  './ssi-core.js?v=algset-controls-v1',
);
