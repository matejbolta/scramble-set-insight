(function (global) {
  ...
  const MIDGE_STICKERS = Object.freeze(EDGE_PIECE_GROUPS.flat());
  ...
  function geometryForSize(size) {
    ...
    if (!geometryCache.has(size)) {
      geometryCache.set(size, {
        ...
        ...(size === 5
          ? {
              midge: createGeometry('midge', MIDGE_STICKERS, size),
  ...
  function buildBigCubeState(
    ...
    return {
      ...
      ...(size === 5
        ? {
            midges: projectState(active.midge, geometry.midge),
